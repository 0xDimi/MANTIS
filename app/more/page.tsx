      ...
      <section className="stackMd">
        <article className="card stackSm">
          ...
          <p className="panelText">
            {tr(
              ...
              'Το MANTIS είναι εφαρμογή αγορών πρόβλεψης με έμφαση στην πιθανότητα. Εκφράζεις άποψη αγοράζοντας μετοχές Ναι ή Όχι σε πραγματικά ερωτήματα.'
            )}
          </p>
        </article>
        ...
        <article className="card stackSm">
          ...
          <ul>
            ...
            <li>{tr(lang, 'Choose BUY or SELL and then YES or NO.', 'Επίλεξε Αγορά ή Πώληση και μετά Ναι ή Όχι.')}</li>
        ...
        <article className="card stackSm">
          ...
          <p className="panelText">
            {tr(
              ...
              'Η εμφανιζόμενη πιθανότητα είναι η πιθανότητα Ναι που αποτιμά η αγορά. Παράδειγμα: 64% σημαίνει ότι η αγορά τιμολογεί περίπου 64% πιθανότητα για Ναι και 36% για Όχι.'
            )}
          </p>
          <p className="panelText">
            {tr(
        ...
        <article className="card stackSm">
          ...
          <ul>
            ...
            <li>{tr(lang, 'At close, trading stops. Then outcome is resolved as YES, NO, or VOID.', 'Στη λήξη σταματά η διαπραγμάτευση. Μετά το αποτέλεσμα επιλύεται ως Ναι, Όχι ή Άκυρο.')}</li>
        ...
        <article className="card stackSm">
          ...
          <ul>
            ...
            <li>{tr(lang, 'Read void rules before entering size.', 'Διάβασε τους κανόνες ακύρωσης πριν βάλεις μέγεθος.')}</li>
          </ul>
        </article>
