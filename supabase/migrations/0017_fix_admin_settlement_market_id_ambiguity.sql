-- 0017_fix_admin_settlement_market_id_ambiguity.sql
-- Fix PL/pgSQL ambiguity in admin settlement function where output-column variables shadow table columns.
...
begin
  ...
  loop
    ...
    set
      available_balance = wa.available_balance + v_wallet_delta,
      realized_pnl = wa.realized_pnl + v_realized_delta,
      updated_at = now()
